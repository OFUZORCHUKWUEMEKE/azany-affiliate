        ...
        <>
            <Layout>
                ...
                <div className="w-full bg-gray-50 min-h-screen overflow-hidden md:py-10">
                    <Stack spacing={3}>
                        <div className='p-3 rounded-md md:w-[75%] w-full mx-auto'>
                            <div className='py-4 md:w-[75%] w-full mx-auto'>
                        ...
                        <div className="w-[90%] mx-auto">
                            ...
                            {Transactions && (
                                Transactions.map((transaction) => (
                                    <div key={transaction.amount} className="px-4 py-4 cursor-pointer hover:bg-gray-100">
