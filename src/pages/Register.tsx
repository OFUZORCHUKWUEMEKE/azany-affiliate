                        ...
                        <div>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="py-3 space-y-2">
                                    ...
                                    <input className="w-full py-2 px-4  bg-gray-100  outline-none rounded-md" name="name" placeholder='Enter Full Name' />
                                </div>
                                <div className="py-3 space-y-2">
                                    <label className="mt-2">Email</label>
                                    <input className="w-full py-2 px-4 bg-gray-100 outline-none rounded-md" name="email" placeholder='Enter Email' />
                                </div>
                                <div className="py-3 space-y-2">
                                    <label className="mt-2">Password</label>
                                    <input className="w-full py-2 px-4 bg-gray-100 outline-none rounded-md" name="password" placeholder='Enter Password' />
                                </div>
                                <div className="py-3 space-y-2">
