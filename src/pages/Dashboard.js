            ...
            <Stack spacing={2}>
              <div className='p-5 rounded-md md:w-[90%] w-[90%]  mx-auto bg-white'>
                <div className="space-y-3">
                  ...
                  <h2 className="text-gray-400">WELCOME OFUZOR CHUKWUEMEKE</h2>
                        ...
                        <div className="p-4 w-full mx-auto">
                          ...
                          {Transactions && (
                            Transactions.slice(0, 4).map((transaction) => (
                              <div key={transaction.amount} className="px-4 py-4 hover:bg-gray-100 cursor-pointer">
                          ...
                          <div className="py-4">
                            ...
                            {downlines && (
                              downlines.map((downline) => (
                                <div key={downline.date} className='flex py-4 mt-3 px-4 hover:bg-gray-100 cursor-pointer  w-full mx-auto items-center justify-between'>
                                  <div>
