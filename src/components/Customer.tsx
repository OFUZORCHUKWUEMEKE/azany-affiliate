      ...
      <div className="bg-[#f7f3f4] py-8 w-full">
        <div className='md:w-4/5 w-full mx-auto flex-col md:flex-row flex items-center justify-between'>
            ...
            <Stack spacing={2}>
              <div className="md:w-4/5 w-[95%] mx-auto rounded-[40px] bg-white shadow-md py-4">
                <div className="sm:w-4/5 w-[90%] mx-auto">
                  ...
                  <div className="py-4">
                    <p className='hidden md:block leading-[1.8]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit rem quibusdam quaerat officia excepturi eos similique ipsam totam voluptate</p>
              ...
              <div className='w-full'>
                <div className="w-[90%] md:w-4/5 flex-col-reverse md:flex-row mx-auto bg-white rounded-lg py-3">
          ...
          <div className="space-y-6 w-[90%] mx-auto py-6 flex-1">
            <h1 className="text-3xl md:text-5xl">Excellent Customer Support</h1>
            <p className='text-xl leading-[1.8]'>Our five star customer success team is smart, friendly and quick to help you 24/7.</p>
