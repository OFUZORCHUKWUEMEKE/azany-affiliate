            ...
            <div className="relative">
                <nav className="w-4/5 mx-auto py-2">
                    <div className='flex justify-between items-center'>
                        <h2 className='text-pink-400 font-bold cursor-pointer text-2xl font-mono'>Azany</h2>
                ...
                <div className='py-4 mt-2 space-y-3 w-full'>
                    <h1 className='md:text-5xl text-2xl font-bold text-center' >Earn Money From Our Networking</h1>
                    <h1 className='md:text-5xl text-2xl font-bold text-center' >And Referral System</h1>
                </div>
                <p className='text-center text-xl text-gray-500 mt-2' >Manage multiple affiliate programs, track affiliate partner performance, assign commissions and issue payouts on one</p>
